...
<script type="text/javascript">
	$(function(){
		$.ajax({
			...
			data:{
				"condition":"parentid,cid,cname,description",
			},
			dataType:"json",
		...
		$(".catebtn").click(function(){
			$.ajax({
				type:"POST",
				url:"http://localhost/thinkphp-cms/index.php/v1/category/add",
		...
		function updclickEvent(){
			...
			$(".bianjibtn").click(function(){
				...
				$(".catebtn").click(function(){
					$.ajax({
						type:"put",
						url:"http://localhost/thinkphp-cms/index.php/v1/category/upd",
						data:$("#addCate").serialize(),
						dataType:"json",
						success:function(data){
							if(data.flag){
		...
		function delclickEvent(){
			...
			$(".shanchubtn").click(function(){
				...
				$.ajax({
					type:"DELETE",
					url:"http://localhost/thinkphp-cms/index.php/v1/category/del",
					data:{
						"cid":aid,
					},
					dataType:"json",
